...
- Web UI Setting page controls overlay colors, line styles, label colors, session fill, and right-side chart spacing, with values saved in browser local storage
